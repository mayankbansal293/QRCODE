    ...
    return (
        <div className="flex flex-col md:flex-row p-4 md:p-8">
          <div className="w-full md:w-1/4 mb-4 md:mb-0">
            <Image src={'/demo.png'} alt="Main Product" width={50} height={50} className="mb-4 w-full" />
          ...
          <div className="w-full md:w-3/4 pl-0 md:pl-8">
            ...
            <div className="mb-4">
              ...
              {discountPrice && <span className="text-sm line-through ml-2">${discountPrice} (5% off)</span>}
            </div>
            <div className="mb-4">
              <label>Size:</label>
            ...
            <div className="mt-4">
              <button className="bg-red-600 text-white p-2 w
    -full">Add to Basket</button>
    </div>
    </div>
    </div>
    );
